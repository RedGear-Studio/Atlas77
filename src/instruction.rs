...
/// 
///Todo: Rework a lot of OpCode, cuz why using multiple Load/Math opcodes when we can just use one
/// and use the one operand parameter to determine what to do with it like `STORE TYPE_TO_STORE REGISTER TABLE_REFERENCE`
...
mod tests {
    ...
    fn test_str_to_opcode() {
        let opcode = Opcode::from(CompleteStr("store"));

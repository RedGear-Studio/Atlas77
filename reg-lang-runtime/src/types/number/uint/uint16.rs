...
impl Arithmetics<UInt16> for UInt16 {
    fn add(self, other: Self) -> Self {
        return UInt16(self.0 + other.0);
    }
    ...
    fn div(self, other: Self) -> Self {
        match other {
            UInt16(0) => panic!("Number Error: Cannot divide by zero. \"{} / {}\"", self.0, '0'),
            _ => {
                return UInt16(self.0 / other.0);
            }
        }
    ...
    fn pow(self, other: Self) -> Self {
        return UInt16(self.0.pow(other.0 as u32));
    }
}

impl Casting for UInt16 {

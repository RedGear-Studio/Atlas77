...
impl Arithmetics<UInt8> for UInt8 {
    fn add(self, other: Self) -> Self {
        return UInt8(self.0 + other.0);
    }
    ...
    fn div(self, other: Self) -> Self {
        match other {
            UInt8(0) => panic!("Number Error: Cannot divide by zero. \"{} / {}\"", self.0, '0'),
            _ => {
                return UInt8(self.0 / other.0);
            }
        }
    ...
    fn pow(self, other: Self) -> Self {
        return UInt8(self.0.pow(other.0 as u32));
    }
}

impl Casting for UInt8 {

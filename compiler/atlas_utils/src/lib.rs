...
impl fmt::Display for Value {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        match self {
            ...
            Int32(i) => write!(f, "{}_i32", i),
            UInt64(u) => write!(f, "{}_u64", u),
            UInt32(u) => write!(f, "{}_u32", u),
            Float64(fl) => write!(f, "{}_f64", fl),
            Float32(fl) => write!(f, "{}_f32", fl),
            Bool(i) => write!(f, "{}", i),
...
mod tests {
    ...
    fn test_fmt_display_value() {
        ...
        assert_eq!(values[0].to_string(), "0_i64");
        assert_eq!(values[1].to_string(), "0_i32");
        assert_eq!(values[2].to_string(), "0_u64");
        assert_eq!(values[3].to_string(), "0_u32");
        assert_eq!(values[4].to_string(), "0_f64");
        assert_eq!(values[5].to_string(), "0_f32");
